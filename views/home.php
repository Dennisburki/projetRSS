        ...
        <div class="card mb-3 border-0" style="max-width: 540px;">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-4 d-flex align-items-center">
                    <img src="<?= $item -> enclosure['url'] ?>" class="img-fluid rounded-start" alt="photo sportif">
                </div>
                </div>
                <div class="col-md-8">
                    <div class="card-body <?= isset($_COOKIE['darkmode']) ? ' black' : 'white' ?> border-0">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header row text-center <?= isset($_COOKIE['darkmode']) ? ' black' : 'white' ?>">
                                        <p class="modal-title col-lg-12" id="exampleModalLabel"><?= $item->pubDate ?></p>
